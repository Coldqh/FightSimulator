...
const VERSION = "root-cache-fix-2.3.5";
const SCHEMA = 235;
...
copy("src/patches/root-cache-fix-2.3.5.js");
...
const patchScript = '  <script src="src/patches/root-cache-fix-2.3.5.js?v=2.3.5"></script>';
...
[
  ...
  "reset-cache.html",
  "version.json",
  "verify-root-fix-2.3.5.cjs",
  "start-clean-local-2.3.5.cjs",
  "README_ROOT_FIX_2.3.5.md",
  ".github/workflows/pages.yml",
  ".nojekyll"
].forEach(copy);

console.log("");
console.log("ROOT FIX APPLIED: " + VERSION);
console.log("");
console.log("Run now:");
console.log("  node verify-root-fix-2.3.5.cjs");
console.log("  node start-clean-local-2.3.5.cjs");
console.log("");
console.log("Use only this fresh local URL:");
console.log("  http://127.0.0.1:5185/reset-cache.html");
console.log("");
console.log("If localhost:5173 still shows 2.3.0, open this once:");
