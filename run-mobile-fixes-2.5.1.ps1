...
$script = Join-Path $PSScriptRoot "apply-mobile-fixes-2.5.1.cjs"
...
Copy-Item $script (Join-Path $repo "apply-mobile-fixes-2.5.1.cjs") -Force

Push-Location $repo
node apply-mobile-fixes-2.5.1.cjs
Remove-Item ".\apply-mobile-fixes-2.5.1.cjs" -Force -ErrorAction SilentlyContinue
Pop-Location
