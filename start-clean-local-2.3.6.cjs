// Clean local static server for Fight World FIGHT ROWS FIX 2.3.6
...
if (!fs.existsSync(path.join(ROOT, "index.html")) || !fs.existsSync(path.join(ROOT, "reset-cache.html"))) {
  throw new Error("Run this from the FightSimulator repository root after node apply-fight-rows-2.3.6.cjs");
}
