...
$script = Join-Path $PSScriptRoot "apply-f1-mobile-ui-2.5.0.cjs"
...
Copy-Item $script (Join-Path $repo "apply-f1-mobile-ui-2.5.0.cjs") -Force

Push-Location $repo
node apply-f1-mobile-ui-2.5.0.cjs
Remove-Item ".\apply-f1-mobile-ui-2.5.0.cjs" -Force -ErrorAction SilentlyContinue
Pop-Location
