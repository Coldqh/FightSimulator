(function () {
  ...
  document.addEventListener("click", function (event) {
    if (window.FS.ActionRouter && window.FS.ActionRouter.handleClick) {
      window.FS.ActionRouter.handleClick(event, {
        getState: function () { return state; },
        setState: function (nextState) { state = nextState; },
        saveAndRender: saveAndRender,
        render: render,
        continueCareer: continueCareer,
        importSave: importSave,
        resetCareer: resetCareer,
        createCareerFromForm: createCareerFromForm,
        rebuildWorld: rebuildWorld,
        isFatigueLockedAction: isFatigueLockedAction,
        isFightLockedModal: isFightLockedModal
      });
    }
  });
