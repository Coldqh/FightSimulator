(function () {
  ...
  function resultClass(result) {
    if (window.FS.FightOutcomes && window.FS.FightOutcomes.resultClass) {
      return window.FS.FightOutcomes.resultClass(result);
    }
  ...
  function buildFightInsight(data) {
    if (window.FS.FightOutcomes && window.FS.FightOutcomes.buildFightInsight) {
      return window.FS.FightOutcomes.buildFightInsight(data);
    }
    return { title: "", lines: [] };
  }
